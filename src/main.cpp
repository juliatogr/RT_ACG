    ...
    std::vector<PointLightSource>*& lightSourceList)
{
    ...
    Material* green_50 = new Phong(Vector3D(0.2, 0.9, 0.3), Vector3D(0.2, 0.9, 0.2), 50);
    Material* purple_30 = new Phong(Vector3D(0.6, 0.2, 0.6), Vector3D(0.5, 0.2, 0.5), 30);
    Material* pink_80 = new Phong(Vector3D(0.7, 0.2, 0.3), Vector3D(0.6, 0.2, 0.2), 80);
